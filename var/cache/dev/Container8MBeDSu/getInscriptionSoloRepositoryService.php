 ...
 */
class getInscriptionSoloRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InscriptionSoloRepository' shared autowired service.
     *
     * @return \App\Repository\InscriptionSoloRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InscriptionSoloRepository.php';

        return $container->privates['App\\Repository\\InscriptionSoloRepository'] = new \App\Repository\InscriptionSoloRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
