...
class __TwigTemplate_7462f440a46e609c90a5a4bdccf0abdb4f85108037a2f562cf5a886b42f652ca extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"form\">
    <div>
        Entre ton adresse email avec laquelle tu t'es inscrit et nous allons t'envoyer un lien !
    </div>
        ";
        // line 16
        ...
        echo "
        <button class=\"btn btn-dark m-auto\">Envoyer</button>
    </div>
    ";
        // line 19
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["requestForm"]) || array_key_exists("requestForm", $context) ? $context["requestForm"] : (function () { throw new RuntimeError('Variable "requestForm" does not exist.', 19, $this->source); })()), 'form_end');
        echo "
";
    ...
    {
        return array (  120 => 19,  114 => 16,  106 => 11,  102 => 9,  93 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}", "reset_password/request.html.twig", "C:\\wamp64\\www\\test\\cosplayProject\\templates\\reset_password\\request.html.twig");
    }
}
